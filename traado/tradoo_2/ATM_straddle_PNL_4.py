...
def on_ticks(ws, ticks):
    ...
    if bought:
        ...
        # New SL condition added here
        if ce_pos["active"] and pe_pos["active"] and pnl_percent <= -2.5:
            logging.info("SL hit: Combined loss exceeded 2.5%. Exiting both positions.")
            square_off_all()
            ws.close()
            return
